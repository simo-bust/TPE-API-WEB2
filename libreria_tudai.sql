...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-11-2024 a las 01:24:45
...
INSERT INTO `libro` (`ID_Libro`, `titulo`, `autor`, `genero`, `precio`, `descripcion`, `imagen`, `ID_Editorial`) VALUES
...
(9, 'DUNE: Parte 2', 'Frank Herbert', 'Postapocalíptico', 50000, '\"Dune\", el periplo de un héroe mítico y con una enorme carga emocional, cuenta la historia de Paul Atreides. Se trata de un joven brillante y de gran talento con un destino grandioso que no comprende todavía y que deberá viajar al planeta más peligroso del universo para asegurar el futuro de su familia y de su pueblo. Mientras las fuerzas del mal se enfrentan por uno de los recursos más excepcionales del planeta que tiene el poder de desbloquear todo el potencial de la humanidad, solo los que logren dominar sus miedos podrán sobrevivir.', '', 1),
(30, 'BEN 10', 'Cartoon Network', 'Animado', 10000, 'BEN 10: EL LIBRO', '', 2),
(40, 'Nacidos de la bruma: El Imperio FInal', 'Brandon Sanderson', 'Fantasia', 30000, '', '', 1),
(41, 'Nacidos de la bruma: El pozo de ascension', 'Brandon Sanderson', 'Fantasia', 30000, '', '', 1),
(42, 'Nacidos de la bruma: El heroe de las eras', 'Brandon Sanderson', 'Fantasia', 30000, '', '', 1),
(43, 'Nacidos de la bruma SAGA COMPLETA', 'Brandon Sanderson', 'Fantasia', 100000, '', '', 4);
...
(2, 'webadmin', '$2y$10$rqmQVMUuwQc4MHBbcJ0yS.YahiS8nJ.fZ.7mVyskgiPWeQE6tZAqa');
